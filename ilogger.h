...
class ILogger
{
    public:
        ...
        virtual void writeToLogMap(const Map& map, const std::list<ANode>& path) = 0;
        ...
        virtual void writeToLogPath(const std::list<ANode>& path) = 0;
        virtual void writeToLogHPpath(const std::list<ANode>& path) = 0;
